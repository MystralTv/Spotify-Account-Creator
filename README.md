...
- ✅  150 Stars | Password Changer

- ✅  250 Stars | Fixed all issue, added bypassing challenge


## ✍️ Usage
1. Run `Spotify Account Creator`


2. (Optional) Create a `proxies.txt` file in ip:port or username:password@hostname:port format 


  ### Or
  
 1. Click and watch the [video](https://youtu.be/9L8-80-NByw). 
